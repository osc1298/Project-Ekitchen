...
using ekitchen.Entidades.Repositorios;
using ekitchen.Entidades.Repositorios.Interfaces;
using ekitchen.Servicios;
...
namespace ekitchen.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ekitchen.Api", Version = "v1" });
            });
   ...
   x.JsonSerializerOptions.ReferenceHandler = ReferenceHandler.Preserve);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ekitchen.Api v1"));
            }
